package ejerciciosMAP.ejer8.main;
...
public class Votacion {
	...
	private static boolean agregarVoto(String nombre) {
		...
		if(candidatos.containsKey(nombre)) {
			...
			System.out.println("No hay ningun candidato con ese nombre");
			return agregado;
		}
